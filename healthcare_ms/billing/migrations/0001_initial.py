    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_claimed', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Amount Claimed')),
                ('amount_approved', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Amount Approved')),
                ('insurance_status', models.CharField(choices=[('submitted', 'Submitted'), ('processing', 'Processing'), ('approved', 'Approved'), ('rejected', 'Rejected'), ('paid', 'Paid')], default='submitted', max_length=20, verbose_name='Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_status', models.CharField(choices=[('draft', 'Draft'), ('sent', 'Sent'), ('paid', 'Paid'), ('overdue', 'Overdue'), ('cancelled', 'Cancelled')], default='draft', max_length=20, verbose_name='Status')),
                ('notes', models.TextField(blank=True, verbose_name='Notes')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True)),
                ('guid', models.UUIDField(default=uuid.uuid4, editable=False, help_text='This field is automatically determined by the system, do not interfere.', unique=True, verbose_name='Unique ID')),
                ('code', models.CharField(max_length=20, unique=True, verbose_name='Service Code')),
