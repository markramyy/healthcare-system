    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_number', models.CharField(blank=True, max_length=50, verbose_name='Group Number')),
                ('coverage_start_date', models.DateField(verbose_name='Coverage Start Date')),
                ('coverage_end_date', models.DateField(blank=True, null=True, verbose_name='Coverage End Date')),
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('deductible', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Deductible ($)')),
                ('copayment', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Co-payment ($)')),
                ('coinsurance', models.DecimalField(decimal_places=2, default=0, max_digits=5, verbose_name='Co-insurance (%)')),
                ('out_of_pocket_max', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Out-of-pocket Maximum ($)')),
