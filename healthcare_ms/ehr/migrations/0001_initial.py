    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diagnosis_code', models.CharField(max_length=20, verbose_name='Diagnosis Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('treatment_status', models.CharField(choices=[('planned', 'Planned'), ('in_progress', 'In Progress'), ('completed', 'Completed'), ('cancelled', 'Cancelled')], default='planned', max_length=20, verbose_name='Status')),
            ],
            options={
